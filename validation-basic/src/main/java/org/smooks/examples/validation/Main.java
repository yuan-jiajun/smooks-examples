    ...
    protected static ValidationResult runSmooks(final String messageIn) throws IOException, SAXException, SmooksException {
        ...
        try {
            ...
            executionContext.getContentDeliveryRuntime().addExecutionEventListener(
                new HtmlReportGenerator("target/report/report.html", executionContext.getApplicationContext()));

            // Filter the input message...
            smooks.filterSource(executionContext, new StringSource(messageIn), validationResult, javaResult);
